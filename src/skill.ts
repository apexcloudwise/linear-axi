...
export const SKILL_DESCRIPTION =
  ...
  'create, update, and delete issues, nest work as sub-issues, post comments and read comment threads, list teams, list/filter projects, list cycles, and list labels. ' +
