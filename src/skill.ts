...
export const SKILL_DESCRIPTION =
  ...
  'create, update, and delete issues, nest work as sub-issues, post, edit, and delete comments and read comment threads, list teams, list/filter projects, list cycles, and list labels. ' +
  ...
  'breaking an issue into sub-issues with `issue create --parent` and reading them back with `issue view --full`, ' +
  'commenting on or reading an issue discussion via `comment list`, editing or removing a comment via `comment update/delete <id>` (ids come from `comment list`), discovering team keys via `teams`, scoping work to a project via `projects` ' +
